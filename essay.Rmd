...
As any statistical test, the ANCOVA has a series of assumptions that need to be met for the conclusions taken from it to be valid [@Field_2012]. As the it is a parametric test, first, the assumptions that are common to this type of test need to be true [@Field_2012]. These assumptions are:
