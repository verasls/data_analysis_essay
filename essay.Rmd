...
The panels as shown in Figure \@ref(fig:rstudio) are in the default position and you should find your new RStudio installation like that. However, you can also modify the panels position by going to Tools > Global Options > Pane Layout. Also, the RStudio theme can be altered at the Appearance menu in the Global Options.
